INSERT INTO tb_user (cpf, course, email, register, name, password, contributor_type) VALUES ('25012025456', 'Sistemas de Informação', 'vpc@ufv.br', 5973, 'Victor Paiva', 'vpcastro00', 0);
INSERT INTO tb_user (cpf, course, email, register, name, password, contributor_type) VALUES ('85214565788', 'Engenharia de Dados', 'rachel@ufv.br', 4444, 'Rachel Reis', 'rachel200', 1);
INSERT INTO tb_user (cpf, course, email, register, name, password, contributor_type) VALUES ('25668445223', 'Sistemas de Informação', 'dudu@ufv.br', 6021, 'Eduardo Nunes', 'dudu85', 0);
